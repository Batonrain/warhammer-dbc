...
describe("источники по умолчанию", () => {
  it("зарегистрированы основная книга, раса, Покровительство, Происхождение, предметы, Аватар Резни, Шаман Зверолюдей, Адъютант, Зависимость и Дредноут", () => {
    expect(getRuleSources().map(([key]) => key))
      .toEqual(["core", "race", "patron", "homeworld", "items", "avatarOfSlaughter", "beastmanShaman", "adjutant", "addiction", "dreadnought"]);
  });
