...
describe("источники по умолчанию", () => {
  it("зарегистрированы основная книга, раса, Покровительство, Происхождение, предметы, Аватар Резни, Шаман Зверолюдей, Адъютант, Дредноут и Локус Неизбежности", () => {
    expect(getRuleSources().map(([key]) => key))
      .toEqual(["core", "race", "patron", "homeworld", "items", "avatarOfSlaughter", "beastmanShaman", "adjutant", "dreadnought", "daemonInevitability"]);
  });
