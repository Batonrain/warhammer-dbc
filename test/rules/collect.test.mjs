...
describe("источники по умолчанию", () => {
  it("зарегистрированы основная книга, ситуативные штрафы, Состояния, раса, Пути Азуриан, Покровительство, Происхождение, предметы, Аватар Резни, Шаман Зверолюдей, Синэстезия, Адъютант, Зависимость, Дредноут и Локус Неизбежности", () => {
    ...
    expect([...getRuleSources().map(([key]) => key)].sort())
      .toEqual(["addiction", "adjutant", "avatarOfSlaughter", "beastmanShaman", "conditions", "core",
                "daemonInevitability", "dreadnought", "homeworld", "items", "paths", "patron",
