...
describe("источники по умолчанию", () => {
  it("зарегистрированы основная книга, ситуативные штрафы, Состояния, раса, Пути Азуриан, Покровительство, Происхождение, предметы, Уравнитель, Аватар Резни, Шаман Зверолюдей, Синэстезия, Адъютант, Зависимость, Дредноут, Локус Неизбежности, Ненависть и Пожиратель Знаний", () => {
    ...
    expect([...getRuleSources().map(([key]) => key)].sort())
      .toEqual(["addiction", "adjutant", "avatarOfSlaughter", "beastmanShaman", "conditions", "core",
                ...
                "opposedTarget", "paths", "patron", "race", "situational", "synesthesia"]);
  });
