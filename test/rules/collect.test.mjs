...
describe("источники по умолчанию", () => {
  it("зарегистрированы основная книга (несёт и Аватар Резни, wdbc-shr), ситуативные штрафы, Состояния, раса, Пути Азуриан, Покровительство, Происхождение, предметы, Уравнитель, Шаман Зверолюдей, Синэстезия, Адъютант, Зависимость, Дредноут, Локус Неизбежности и Цель поддерживаемой психосилы", () => {
    ...
    // opposedTarget (wdbc-1rno, 09.09.2026) — Уравнитель, переброс, который
    // ЦЕЛЬ навязывает атакующему (обратное направление от "items").
    // psychicSustainTarget (wdbc-lmd2, найдено внутри wdbc-q0q8) — Dragon
    // Scales/Wings of the Phoenix: психосила даёт способность цели каста, не
    // владельцу.
