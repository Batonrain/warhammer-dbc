...
describe("источники по умолчанию", () => {
  it("зарегистрированы основная книга, ситуативные штрафы, Состояния, раса, Пути Азуриан, Покровительство, Происхождение, предметы, Уравнитель, Аватар Резни, Шаман Зверолюдей, Синэстезия, Адъютант, Зависимость, Дредноут, Локус Неизбежности и Цель поддерживаемой психосилы", () => {
