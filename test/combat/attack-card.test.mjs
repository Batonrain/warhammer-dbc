...
//
// Заглушка нужна с переездом на общий сборщик карточек (wdbc-ec0r): statLine
// в module/helpers/test-card.mjs экранирует подписи ячеек через
// foundry.utils.escapeHTML, и без глобали разметка не соберётся. Документы
// Foundry модуль по-прежнему не читает — заглушка здесь только ради esc.
