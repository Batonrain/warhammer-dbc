...
import { applyGrappleOnHit, grapplePartner, endGrapple, isBiteWeapon, crunchWeapon, tentacleTechDef, tentacleBonus, swingProfile, throwProfile } from "../../module/combat/grapple.mjs";
