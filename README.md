...
Релиз не собирается, если PR затрагивает только `README.md`, `LICENSE`, `.gitignore`, `.gitattributes`, `.github/` или `packs-src/`. Правка документации не должна поднимать всем игрокам обновление на 38 МБ.
