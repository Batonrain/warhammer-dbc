...
export const PSY_PATHS = {
  ...
  sigillite:     { label: "Руны Сигиллитов",       req: "Черта Sigillite Magic / Магия Сигиллитов", testMod: 0, ePR: 0, phenMod: 0,
                   ...
                   note: "Только Безопасный/Обычный режим; Феномен лишь на 99. Цена — бPR психосилы × 2 Руны, считается и списывается сама. НЕ автоматизировано и остаётся на столе: −30 всем попыткам обнаружить манифестацию, доп. −30 при варп-прорыве, одновременное использование механик Инкантации (+1 эPR, +20 Феномен), Медитации (+3 эPR) и Нечестивых Символов (−20 Феномен) — выберите нужный Путь отдельно, доступ к Тауматургии." }
};
