...
// Подтипы Психострельбы
export const PSY_SHOOT_SUBTYPES = {
  "":        "—",
  projectile:"Психический Снаряд",
  barrage:   "Психический Обстрел",
  storm:     "Психический Шторм",
  blast:     "Психический Взрыв (X)",
  breath:    "Психическое Дыхание"
};
