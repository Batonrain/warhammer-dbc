...
export const CAPABILITIES = {
  ...
  "gift.tzeentch.perfectSorcerer": {
    label: "Реализовано: снимает книжный запрет Высшего Колдовства по Покровительству (гейт на манифестации, не только на изучении). НЕ реализовано: обучение других психосилам (в системе такой механики нет вовсе, решено пока игнорировать); «Фокус Дисциплины» — механики Фокуса в системе нет ни у кого, заведён отдельный тикет wdbc-l6zg, этот Дар — его первый потребитель",
    source: "Дар Тзинч (Perfect Sorcerer)",
    reader: "module/rules/perfect-sorcerer.mjs::highSorceryManifestBlocked, гейт в module/sheets/tabs/psychic.mjs::showManifestDialog"
  },
