...
export const CAPABILITIES = {
  ...
  "gift.nurgle.unseenBeggar": {
    label: "Механизирован ГЕЙТ и переключатель (wdbc-1rno): Дар помечен activatable, кнопка ВКЛ/выкл на вкладке ЭФФЕКТЫ (mutgiftToggleActive) не даёт наложить чары, пока надето хоть что-то лучше Poor.Q, и называет виновников поимённо. «Снаряжение» — надетое (system.equipped) среди типов с Качеством: armor/weapon/gear/forcefield; вживлённые импланты намеренно не считаются (книга говорит «носит», а имплант полудействием не снять), ненадетое в рюкзаке — тоже. НЕ смоделировано: сама иллюзия «ещё один нищий, не стоящий внимания» — это поведение наблюдателей, а не состояние актора (тот же уровень, что у Иконы Богохульства), и цена в полудействие на вход/выход (та же граница, что у gift.khorne.livingWeapon)",
    source: "Дар Нургл (Unseen Beggar)",
    reader: "module/rules/unseen-beggar.mjs (чистая: betterThanPoorEquipped/unseenBeggarGateOk) — гейт стоит в module/sheets/actor-sheet.mjs::onMutgiftToggleActive; тумблер сам — module/data/item/mutation.mjs (activatable/active) + module/apps/effects.mjs::isItemActive"
  },
  "gift.nurgle.vulture": {
