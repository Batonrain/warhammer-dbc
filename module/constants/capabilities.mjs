...
export const CAPABILITIES = {
  ...
  "gift.khorne.infernalArmiger": {
    label: "Реализована (wdbc-1rno, серия по минион-без-слота) выдача готового Ритуала «Призыв Связанного Оруженосца (Кхорн)» (kind:\"equipment\", equipMode:\"direct\") — простым 10-минутным ритуалом без теста призывает Кровопускателя из Бестиария и сразу привязывает его Миньоном БЕЗ траты слотов (system.masterUuid, module/apps/ritual-cast.mjs::castNoTestRitual + demon-summon.mjs asMinion). НЕ реализовано: автопобеда во Владычестве против него (Шаг E, ещё не сделан), вселение в оружие/скакуна (Шаг D — переиспользовать «Осквернение», module/apps/veil.mjs, механизм уже есть, подключение к Дару ещё нет), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — модификатор к Тесту Нестабильности демона, testMod modScope:\"instability\" с Cor.b МАСТЕРА, а не демона — кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола",
    source: "Дар Кхорн (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Кхорн/Infernal_Armiger___Инфернальный_Оруженос_felvy1sj4gIJFbIQ.json (entry infernalArmiger-ritual) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerKhorneQ1a.json"
  },
  "gift.nurgle.infernalArmiger": {
    label: "Реализована (wdbc-1rno, серия по минион-без-слота) выдача готового Ритуала «Призыв Связанного Оруженосца (Нургл)» (kind:\"equipment\", equipMode:\"direct\") — простым 10-минутным ритуалом без теста призывает Чумоноса из Бестиария и сразу привязывает его Миньоном БЕЗ траты слотов (system.masterUuid, module/apps/ritual-cast.mjs::castNoTestRitual + demon-summon.mjs asMinion). НЕ реализовано: автопобеда во Владычестве против него (Шаг E), вселение в оружие/скакуна (Шаг D — «Осквернение», module/apps/veil.mjs, механизм есть, подключение к Дару нет), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола",
    source: "Дар Нургл (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Нургл/Infernal_Armiger___Инфернальный_Оруженос_ai4mBT9bhVwZqx8t.json (entry infernalArmiger-ritual) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerNurgleQ2b.json"
  },
  "gift.slaanesh.infernalArmiger": {
    label: "Реализована (wdbc-1rno, серия по минион-без-слота) выдача готового Ритуала «Призыв Связанного Оруженосца (Слаанеш)» (kind:\"equipment\", equipMode:\"direct\") — простым 10-минутным ритуалом без теста призывает Демонетку из Бестиария и сразу привязывает её Миньоном БЕЗ траты слотов (system.masterUuid, module/apps/ritual-cast.mjs::castNoTestRitual + demon-summon.mjs asMinion). НЕ реализовано: автопобеда во Владычестве против неё (Шаг E), вселение в оружие/скакуна (Шаг D — «Осквернение», module/apps/veil.mjs, механизм есть, подключение к Дару нет), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола",
    source: "Дар Слаанеш (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Слаанеш/Infernal_Armiger___Инфернальный_Оруженос_Ot9gweExln1toPnn.json (entry infernalArmiger-ritual) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerSlaanQ3c1.json"
  },
  "gift.tzeentch.infernalArmiger": {
    label: "Реализована (wdbc-1rno, серия по минион-без-слота) выдача готового Ритуала «Призыв Связанного Оруженосца (Тзинч)» (kind:\"equipment\", equipMode:\"direct\") — простым 10-минутным ритуалом без теста призывает Розового Ужаса из Бестиария и сразу привязывает его Миньоном БЕЗ траты слотов (system.masterUuid, module/apps/ritual-cast.mjs::castNoTestRitual + demon-summon.mjs asMinion). НЕ реализовано: автопобеда во Владычестве против него (Шаг E), вселение в оружие/скакуна (Шаг D — «Осквернение», module/apps/veil.mjs, механизм есть, подключение к Дару нет), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола, расщепление на двух Синих Ужасов — отдельная неисследованная механика",
    source: "Дар Тзинч (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Тзинч/Infernal_Armiger___Инфернальный_Оруженос_dhnszZq38C0nRzNH.json (entry infernalArmiger-ritual) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerTzeenQ4d2.json"
  },
