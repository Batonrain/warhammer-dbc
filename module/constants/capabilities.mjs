...
export const CAPABILITIES = {
  ...
  "gift.khorne.infernalArmiger": {
    label: "Реализовано (wdbc-1rno, шаги B/C/D): готовый Ритуал «Призыв Связанного Оруженосца (Кхорн)» — простым 10-минутным ритуалом без теста призывает Кровопускателя из Бестиария; второй Ритуал того же Дара («Вселение Оруженосца в Оружие») тем же путём вселяет его в выбранное оружие Ритуалиста, превращая его в Демоническое Оружие (+W.b Dmg/Pen, Reinforced, теряет Primitive/Sanctified — module/apps/armiger-weapon.mjs, без похода по случайной таблице Осквернения — книга не даёт для неё оснований, раз нет броска). Изгнание демона из оружия ВСЕГДА уничтожает его, без шанса стать Руническим (module/sheets/item-sheet.mjs::onArmigerWeaponRelease). Призванный демон (в любом исходе) сразу встаёт Миньоном БЕЗ траты слотов (system.masterUuid). НЕ реализовано: автопобеда во Владычестве против него (Шаг E), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола",
    source: "Дар Кхорн (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Кхорн/Infernal_Armiger___Инфернальный_Оруженос_felvy1sj4gIJFbIQ.json (entries infernalArmiger-ritual/-ritual-weapon) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerKhorneQ1a.json + Bind_the_Armiger_into_a_Weapon___Вселени_ArmigerKhWeapQ1a.json"
  },
  "gift.nurgle.infernalArmiger": {
    label: "Реализовано (wdbc-1rno, шаги B/C/D): готовый Ритуал «Призыв Связанного Оруженосца (Нургл)» — простым 10-минутным ритуалом без теста призывает Чумоноса из Бестиария; второй Ритуал того же Дара («Вселение Оруженосца в Оружие») тем же путём вселяет его в выбранное оружие Ритуалиста, превращая его в Демоническое Оружие (+W.b Dmg/Pen, Reinforced, теряет Primitive/Sanctified — module/apps/armiger-weapon.mjs, без случайной таблицы Осквернения — нет броска, нет оснований для случайных свойств). Изгнание демона из оружия ВСЕГДА уничтожает его, без шанса стать Руническим. Призванный демон (в любом исходе) сразу встаёт Миньоном БЕЗ траты слотов. НЕ реализовано: автопобеда во Владычестве против него (Шаг E), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола",
    source: "Дар Нургл (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Нургл/Infernal_Armiger___Инфернальный_Оруженос_ai4mBT9bhVwZqx8t.json (entries infernalArmiger-ritual/-ritual-weapon) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerNurgleQ2b.json + Bind_the_Armiger_into_a_Weapon___Вселени_ArmigerNuWeapQ2b.json"
  },
  "gift.slaanesh.infernalArmiger": {
    label: "Реализовано (wdbc-1rno, шаги B/C/D): готовый Ритуал «Призыв Связанного Оруженосца (Слаанеш)» — простым 10-минутным ритуалом без теста призывает Демонетку из Бестиария; второй Ритуал того же Дара («Вселение Оруженосца в Оружие») тем же путём вселяет её в выбранное оружие Ритуалиста, превращая его в Демоническое Оружие (+W.b Dmg/Pen, Reinforced, теряет Primitive/Sanctified — module/apps/armiger-weapon.mjs, без случайной таблицы Осквернения — нет броска, нет оснований для случайных свойств). Изгнание демона из оружия ВСЕГДА уничтожает его, без шанса стать Руническим. Призванный демон (в любом исходе) сразу встаёт Миньоном БЕЗ траты слотов. НЕ реализовано: автопобеда во Владычестве против неё (Шаг E), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола",
    source: "Дар Слаанеш (Infernal Armiger)",
    reader: "packs-src/mutations/Дары_Богов/Слаанеш/Infernal_Armiger___Инфернальный_Оруженос_Ot9gweExln1toPnn.json (entries infernalArmiger-ritual/-ritual-weapon) + packs-src/rituals/Архетипа/Summon_the_Bound_Armiger___Призыв_Связан_ArmigerSlaanQ3c1.json + Bind_the_Armiger_into_a_Weapon___Вселени_ArmigerSlWeapQ3c.json"
  },
  "gift.tzeentch.infernalArmiger": {
    label: "Реализовано (wdbc-1rno, шаги B/C/D): готовый Ритуал «Призыв Связанного Оруженосца (Тзинч)» — простым 10-минутным ритуалом без теста призывает Розового Ужаса из Бестиария; второй Ритуал того же Дара («Вселение Оруженосца в Оружие») тем же путём вселяет его в выбранное оружие Ритуалиста, превращая его в Демоническое Оружие (+W.b Dmg/Pen, Reinforced, теряет Primitive/Sanctified — module/apps/armiger-weapon.mjs, без случайной таблицы Осквернения — нет броска, нет оснований для случайных свойств). Изгнание демона из оружия ВСЕГДА уничтожает его, без шанса стать Руническим. Призванный демон (в любом исходе) сразу встаёт Миньоном БЕЗ траты слотов. НЕ реализовано: автопобеда во Владычестве против него (Шаг E), «Завеса тоньше на Cor.b в радиусе Cor» (Шаг F — testMod modScope:\"instability\" с Cor.b МАСТЕРА, кросс-акторное чтение), «при Inf 60 демон становится возвышенным» — статус-апгрейд, решение стола, расщепление на двух Синих Ужасов — отдельная неисследованная механика",
