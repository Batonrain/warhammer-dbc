...
export const CAPABILITIES = {
  ...
  "mutation.tentacle": {
    label: "+20 на приём Захват и на 5 тестов Борьбы (Заломить/Пересилить/Вырваться/Выкрутиться/Перехватить Контроль); Сжать/Хруст/Метнуть/Укусы броска не делают — бонусу там нечего усиливать; растяжение до 4м/узкие места — флейвор. Субмутации 2-3 (Natural Armour 3) и 8 (+10 S, Unnatural S+2) заведены Механикой самого предмета (packs-src). Остальные 7 не автоматизированы: 1/9/10 — ситуативные действия, не число; 4-5 бонус Карабканья — в системе нет отдельного скоупа теста «Карабканье» (это Athletics, тот же скоуп, что у Заломить/Пересилить — общий testMod задел бы их тоже); 6/7 — свойство оружия (Flexible/Corrosive+Toxic) именно на безоружных атаках щупальцем, для чего нет узкого крепежа",
    source: "Мутация: Tentacle (Общие мутации)",
    reader: "module/sheets/attack-dialog.mjs — resolveSelection (+20 на приём Захват); module/combat/grapple.mjs — tentacleTechDef (+20 на 5 тестов Борьбы)"
  },
