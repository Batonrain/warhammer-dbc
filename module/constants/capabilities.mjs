...
export const CAPABILITIES = {
  ...
  // заглушка данными, reader пуст сознательно ──
  "mutation.addiction": {
    label: "13 субмутаций определяют предмет зависимости (еда/яд/кровь врага и т.п.) — сам акт утоления остаётся отыгрышем, не автоматизирован (нет bd)",
    source: "Мутация: Addiction (Общие мутации)",
    reader: "module/rules/addiction.mjs — addictionPenalty (−10 тестам Навыков со следующих суток без утоления), sheets/actor-sheet.mjs::_rollSkill; кнопка «Утолить» — apps/addiction.mjs"
  },
  "mutation.beastman": {
