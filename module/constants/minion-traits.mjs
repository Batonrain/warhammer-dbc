...
export const MINION_TRAITS = {
  ...
  "Auto-Stabilized":  { cost: 1,  groups: ALL,                              tiers: tiers(true, true, true) },
  "Bestial":          { cost: 0,  groups: only("beast", "daemon"),          tiers: tiers(true, true, true) },
  ...
  "Burrower":         { cost: 1,  groups: ALL,                              tiers: tiers(4, 6, 8), perPoint: 1 },
  "Crawler":          { cost: 1,  groups: ALL,                              tiers: tiers(true, true, true) },
  ...
  "Dark Sight":       { cost: 1,  groups: ALL,                              tiers: tiers(true, true, true) },
  "Deadly Natural Weapons":{ cost: 1, groups: ALL,                          tiers: tiers(null, 2, 4), perPoint: 2 },
  "Digitigrade":      { cost: 1,  groups: ALL,                              tiers: tiers(1, 2, 4), perPoint: 1 },
  "Fanatic":          { cost: 1,  groups: ALL,                              tiers: tiers(true, true, true) },
  "Fear":             { cost: 1,  groups: ALL,                              tiers: tiers(null, 1, 2) },
  "Flyer":            { cost: 1,  groups: ALL,                              tiers: tiers(null, null, 6), perPoint: 1 },
  "From Beyond":      { cost: 1,  groups: ALL,                              tiers: tiers(true, true, true) },
  "Hoverer":          { cost: 1,  groups: ALL,                              tiers: tiers(4, 6, 10), perPoint: 1 },
  ...
  "Nimble":           { cost: 1,  groups: ALL,                              tiers: tiers(null, 5, 10), perPoint: 2 },
  "Parasite":         { cost: 2,  groups: ALL,                              tiers: tiers(true, true, true) },
  "Phase":            { cost: 2,  groups: ALL,                              tiers: tiers(null, null, true) },
  "Possession":       { cost: 2,  groups: ALL,                              tiers: tiers(null, null, true) },
  "Psyber":           { cost: 1,  groups: ALL,                              tiers: tiers(true, true, true) },
  "Psyker": {
    cost: 2, groups: only("human", "beast", "daemon"), tiers: tiers(null, true, true),
    note: "Даёт Psyker (PR 1) и 4 психосилы."
  },
  "Quadruped":        { cost: 1,  groups: ALL,                              tiers: tiers(0, 2, 4), perPoint: 1 },
  "Regeneration":     { cost: 1,  groups: ALL,                              tiers: tiers(null, 2, 4), perPoint: 1 },
