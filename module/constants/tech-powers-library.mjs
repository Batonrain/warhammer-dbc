 ...
 *
 * Данные книги. Содержимое компендиума "warhammer-dbc.tech-powers" живёт в
 * packs-src/tech-powers/ и собирается из него (этап 4 плана); поле folder[]
 * здесь задаёт путь вложенной папки.
 *
