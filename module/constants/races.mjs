...
export const SUBRACE_DATA = {
  mutant: {
    ...
    effect: "+5 Cor и 1 дополнительная мутация на выбор из списка: Животный Гибрид, Циклоп, Глаза-Стебельки, Панцирь, Множественные Глаза, Безголовый, Странные Руки, Величественные Рога, Дополнительная Рука, Хвост, Щупальце, Странный Язык — с субмутацией на выбор (1–10). Навык Deceive или For.Lore (Mutants) по выбору становится дружественным.",
    traits: []
  },
  stunted: {
    label: "Затупленный", cost: 500, tierCosts: [500, 750, 1000, 1250],
    bannedArchetypes: ["witch", "renegadePsyker"], mutationsAsAstartes: true,
    effect: "Трейт Blunted (1); максимум Очков Бесчестия −1 (не ниже 1). За 750/1000/1250 xp — Blunted (2/3/4) и максимум Очков Бесчестия −2/−3/−4 (не ниже 1). Получает мутации как Космодесантник. Не может брать Архетипы, дающие Трейт Psyker.",
  ...
  afriel: {
    ...
    effect: "Клон: 2 Характеристики и 3 Навыка на выбор становятся дружественными. Случайные опасности (обломки, обвалы, снайпер без приоритетной цели) всегда нацеливаются на Африэля; ГМу рекомендуется подбрасывать ему лишние проблемы и креативно подходить к его Критическим Провалам и Критическим Успехам врагов против него.",
    traits: []
  },
  inheritor: {
    label: "Наследник", cost: 1000,
    effect: "Кровь Демон-Принца: максимум Очков Бесчестия +1; видения предка во сне и медитациях. Чудесное Спасение/Божественная Защита: потеря Inf и полученная Cor бросаются дважды, берётся меньшее, с чудесным проявлением предка. Помазанник (5) Демон-Принца; не получает Порчи от временного вселения предка.",
    traits: []
  },
  pariah: {
    label: "Пария", cost: 1500, bannedArchetypes: ["witch", "renegadePsyker"],
    effect: "Аура W.b×3 м (включая самого Парию): иммунитет к психосилам (кроме Непрямых) и демоническим дарам; нельзя тратить и сжигать Очки Бесчестия/Судьбы; сверхъестественные мутации и дары не работают; нельзя получать Порчу (у Парии Cor не выше 0); псайкеры −PR×3, демоны −30 на все тесты; все, кроме Парий, перебрасывают успешные тесты Морали; демоны — тест Нестабильности каждый Ход со штрафом W Парии; вместилища демонов теряют свойства; Ритуалы обрываются, Пария в них не участвует. Социальные тесты −30 (кроме запугивания) с имеющими душу, −60 с псайкерами/демонами. Касание: W−10 или разорвать контакт; псайкеры/демоны — авто-провал и PR/3d10 непоглощаемого R Dmg в торс. Не может брать Архетипы Ведьма и Беглый Псайкер.",
    traits: [{ name: "Pariah / Пария", benefit: "Аура чернокнижия (Untouchable).", hasRating: false, effects: {} }]
  },
  discordant: {
    label: "Дискордант", cost: 1500, bannedArchetypes: ["heretek", "skitarii"],
    effect: "Аура W.b×3 м: электрические устройства отключаются как в поле Haywire (7); механика заклинивает через 1d5+1 Ходов, примитивное оружие не страдает; техночудеса с целью в ауре — Критический Провал; биоорганы — тест T+0 каждые 10 мин, за каждые T.b×2 Провалов орган отторгается; медицина −10…−60. Не действует на технологии Некронов, Эльдар (кроме Тёмных), Орков (при Орках), психические/демонические устройства и Оружие Наследия. Псайкер может сжать ауру до 2 м. Талант Enemy (Adeptus Mechanicus, Dark Mechanicum). Не может брать Архетипы Еретех и Скитарий.",
