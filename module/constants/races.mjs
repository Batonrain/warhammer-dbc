...
// Пути Аэльдари (вместо Мировоззрения). У путей есть уровни — пока учитываем наличие.
export const AELDARI_PATHS = [
  { label: "Путь Видящих", specs: ["Путь Варлока", "Путь Духовидца", "Путь Певца Кости", "Путь Провидца", "Путь Путевидца"] },
  { label: "Путь Воина", specs: [
    "Суинмуре (Воющие Баньши)", "Кьюанснанар (Варп-Пауки)", "Меантокатх (Жалящие Скорпионы)",
    "Есиккаман/Диал-Маман (Зловещие Мстители)", "Киамкурон (Огненные Драконы)",
    "Амон Харакхт (Орлиные Пилоты)", "Меарновас/Сииспеираигх (Пикирующие Ястребы)",
    "Иррикшад (Сверкающие Копья)", "ОтБуанна (Тёмные Жнецы)", "ОтТанн (Теневые Фантомы)"
  ] },
  { label: "Путь Дипломата",     specs: [] },
  { label: "Путь Игрока",        specs: [] },
  { label: "Путь Командования",  specs: [] },
  { label: "Путь Культиватора",  specs: [] },
  { label: "Путь Лекаря",        specs: [] },
  { label: "Путь Летописца",     specs: [] },
  { label: "Путь Мореплавателя", specs: [] },
  { label: "Путь Изгоя (Отступника)", specs: [] },
  { label: "Путь Празднования",  specs: [] },
  { label: "Путь Проклятия",     specs: [] },
  { label: "Путь Пробуждения",   specs: [] },
  { label: "Путь Ремесленника",  specs: [] },
  { label: "Путь Скорби",        specs: [] },
  { label: "Путь Служения",      specs: [] },
  { label: "Путь Сновидений",    specs: [] }
];
