...
export const CATEGORIES = [
  ...
  { label: "Элитные архетипы",        sources: [{ pack: "traits", onlyFolder: "Элитные архетипы" },
                                                  { pack: "talents", onlyFolder: "Элитные архетипы" },
                                                  { pack: "aeldari-traits" },
                                                  { pack: "aeldari-talents" }], tabs: ["abilities"] },
    ...
    <div class="cbrowse-row">
      <div class="cbrowse-row-head">
        ...
        <div class="cbrowse-item" draggable="true" data-uuid="${esc(it.uuid)}" data-doc="${esc(it.doc || "Item")}" data-name="${esc(it.name.toLowerCase())}" data-stackable="${stackable}">
          ...
          ${it.availability != null ? `<span class="pick-req" title="Доступность">R ${esc(it.availability)}</span>` : ""}
