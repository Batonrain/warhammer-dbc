...
//
// Cor 40+ (ИК/УФ-зрение) — отдельный порог, не относящийся к этому файлу:
// нечем моделировать (нет механики спектра зрения), остаётся честным
// остатком.
//
// Cor 80+ (бесплатное Полу-Прицеливание, «если видит цель») — реализовано
// отдельно, в module/rules/aiming.mjs::blackEyesFreeHalfAim (реворк
// Прицеливания, wdbc-1rno.5) — использует isBlackEyesItem отсюда, но живёт
// не здесь, потому что зависит от Прицеливания, а не от видимости.
