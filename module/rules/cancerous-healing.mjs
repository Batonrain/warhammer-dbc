...
/**
 * Штраф A/Ловкость и S/Сила за КАЖДУЮ аблативную Рану — 2 за штуку.
 * Открытый вопрос (не сверяно с книгой напрямую, см. bd wdbc-w8ws): бьёт по
 * Значению (`.totalFx`) характеристики, не по Бонусу — выбрано как менее
 * разрушительный вариант при накоплении многих аблативных Ран, но точная
 * формулировка страницы книги не проверена вживую.
 */
