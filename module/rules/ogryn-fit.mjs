...
//   • «Закрепление оружия убирает все эти штрафы» считается НЕ здесь, а
//     галочкой окна атаки (sheets/attack/mods.mjs, «Огринское оружие
//     Закреплено»), и ровно на ту сумму, что насчитала эта функция. Причина:
//     Закрепление — Полудействие (оружие ставится на укрытие, лафет, бипод
//     или трипод, и держится, пока стрелок не сдвинулся и не повернул оружие
//     вне сектора), то есть решение игрока в конкретной атаке, а не свойство
//     предмета или актора. Хранимого состояния «закреплено» в системе нет —
//     для тяжёлого оружия Закрепление живёт такой же галочкой; заводить под
//     Огринов второй, свой механизм значило бы развести два Закрепления.
//     Обратной стороны (Огрин с человеческим оружием) Закрепление не
//     касается: там мешает не отсутствие упора, а сама рукоять.
