...
// «1р» и специализированные хваты Об/Бл/Кл/Мх/Хв — это способы удержания той
// же одной руки, не отдельный счётчик).
const MELEE_GRIP_HANDS = { "2р": 2, "П": 0, "Л": 0, "П+Л": 0, "Ног": 0, "Гол": 0 };
