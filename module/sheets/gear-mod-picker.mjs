...
// ════════════════════════════════════════════════════════════════════════════
//  «Улучшить» (wdbc-7td8): пункт контекстного меню (ПКМ) строки оружия/брони
//  в таблице Снаряжения (module/sheets/context-menu.mjs, wdbc-njzt — раньше
//  была отдельная кнопка в строке) открывает пикер уже имеющихся у актора
