...
смоделировано: легаси-История «Терпение» (`constants/legacy-weapon.mjs:154`,
«+30/всегда первый в Карауле») — у Легаси-Историй в системе вообще нет
машиночитаемого поля на предмете, общесистемный пробел шире одной находки.
