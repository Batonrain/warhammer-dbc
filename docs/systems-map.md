...
- **Руны Сигиллитов** (wdbc-fsl9, 10.09.2026) — `rules/sigillite-runes.mjs`
  ...
  числами 3 из 6 Талантов (Библиотека Рун/Вычислитель Рун/Рунный Удар);
  Заготовленная Руна (wdbc-p2it), Импровизированная Руна и Прометеев Огонь
  (wdbc-exjp — обоим нужен список изученных Рун, которого в системе нет) —
  не подключены. Живая проверка — wdbc-lx57, не проведена.
