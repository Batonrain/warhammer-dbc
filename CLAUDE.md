...
тип данных, устройство механики (эффекты, Конструктор, миграции), цель проекта,
конвенция отчётов «Для игры:» и соглашения по языку. Второй копии здесь нет
намеренно: одна вещь описана в одном месте.
...
Личные предпочтения пользователя по стилю работы (как менять позицию, как
реагировать на его правки) — не часть этого репозитория, см. пользовательский
`~/.claude/CLAUDE.md`.
