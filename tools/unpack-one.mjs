// tools/unpack-one.mjs — закоммичен и активно используется, не одноразовый.
// Точечно снимает правки одного пака из LevelDB в packs-src, не трогая остальные.
// Запуск: node tools/unpack-one.mjs <имя пака>
//
...
// tools/pack-one.mjs): без этого следующая общая сборка сравнила бы базу со
...
// одному ключу, как и в pack-one.mjs, — чужие записи не теряются, поэтому та
// причина не держащая.
 ...
 * отпечаток вообще удалось прочитать. См. tools/pack-one.mjs::stampAfterPackBuild
